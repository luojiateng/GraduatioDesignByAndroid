package com.jiateng.home.adapter;
...
public class ShopAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.activity_list_shop_home, null);
        ...
        tv_space.setText(shopInfos.get(position).getSpace());
